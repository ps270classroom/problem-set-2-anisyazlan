...
party_incumbent_promote = party_incumbent_promote %>%
  mutate(impressions_millions = promote_prop * 1000000) 
print(party_incumbent_promote)

plot_q3 = ggplot(party_incumbent_promote, aes(impressions_millions)) + geom_histogram()
print(plot_q3)
...
fb_top_plot = ggplot(party_incumbent_promote, aes(x = impressions_millions, y = cand_name)) + geom_bar()
